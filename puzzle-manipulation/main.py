...
import pb_ompl
from file_utils import urdf_merger
from src.puzzle_state import *
...
class ManipulationFlow:
    def __init__(self):
        ...
        urdf_merger.merge_urdf_files("/home/le/ba/pybullet-ompl/models/kuka_iiwa/model_in_2d_plane.urdf",
